...
def show_home_page():
    ...
    st.write("📜 **Profile Report Generation:** Generate detailed Pandas Profiling reports with interactive visualizations.")
    st.write("🤖 **Auto ML Modeling:** Automatically train and compare models, and download the best model for deployment.")

    # Get Started Section
    st.subheader("Get Started with AutoML")
    st.write("AutoML is your gateway to data analysis, data preprocessing and ML modeling. This project simplified the process to help you make the most of your data.")
    ...
    st.write("Get started by uploading your own dataset or use the example Titanic dataset included in sidebar. Select it and let AutoML do the rest!")


    # Final Message
    st.write('<div class="thank-you">Start your journey towards data-driven decision-making with AutoML!</div>', unsafe_allow_html=True)
